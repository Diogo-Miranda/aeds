...
class Q5
{
    ...
    */	
    ...
    /**
     * selectionSort(Jogador jogador[])
     * @param jogador - array a ser tratada
     * @return retorna dados sobre o numero de comparações e movimentações do array
    */
    public static int[] selectionSort(Jogador jogador[])
    {
	    // Dados[0] = numComp
        // Dados[1] = numMov
        int[] dados = new int[2];
            
        // Inicia valores dos contadores com 0	
    ...
    public static void main (String[] args) throws IOException
    {
        ...
        try {
            ...
            int dados[] = selectionSort(jogador);
