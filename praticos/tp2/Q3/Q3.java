...
class Q3
{
    ...
    /**
	 * pesquisaSequencial(Jogador[] jogador, String nome)
     * Pesquisar um jogador de forma sequencial em um array
     * @param Jogador[] jogador - array com os jogadores lidos
     * @param String nome - nome do jogador a ser pesquisado
     * @return int out - numero de comparacoes 
     */
    public static int pesquisaSequencial(Jogador[] jogador, String nome)
    {
		String auxNome;
		boolean isJogador = false;
		int out = 0;
		for(int i = 0; i < jogador.length && !isJogador; i++)
		{
			auxNome = jogador[i].getNome();
    ...
    */	
    ...
    {
        String entrada[] = new String[280];
        int numEntrada = 0;
				
		FileWriter fw = new FileWriter("705657_sequencial.txt");
        ...
        try {
			...
			for(int i = 0; i < numEntrada; i++)
			{	
				num_comp += pesquisaSequencial(jogador, entrada[i]);
			}
			...
			log.write("705657\t"+total+"\t"+num_comp);			
