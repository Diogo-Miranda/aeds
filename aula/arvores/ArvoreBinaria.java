...
public class ArvoreBinaria {
	...
	public static boolean caminhar(No i, No j) 
	{
		boolean isIgual;
		if(i != null && j != null) {
			isIgual = (i.elemento == j.elemento) && caminhar(i.esq, j.esq) && caminhar(i.dir, j.dir);
	...
	public static boolean isIgual(ArvoreBinaria ab1, ArvoreBinaria ab2) 
	{
		boolean isIgual = true;
		isIgual = caminhar(ab1.raiz, ab2.raiz);
		return isIgual;
	}
